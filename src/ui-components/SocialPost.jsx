...
export default function SocialPost(props) {
  const { fig, waitlist, aPIDOCs, overrides, ...rest } = props;
  const  =
    useNavigateAction({ type: "url", url: "" });
  const imageOnClick = useDataStoreCreateAction({
    fields: {},
    model: Waitlist,
    schema: schema,
  });
        ...
        >
          ...
          >
            ...
            <Text
              ...
              onClick={() => {
                ();
              }}
              {...getOverrideProps(
                overrides,
